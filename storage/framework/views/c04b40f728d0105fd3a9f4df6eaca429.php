      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
           ...
           <tr>
            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo e($post->title); ?></strong></td>
            ...
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item edit-post" href="javascript:void(0);" data-post-id="<?php echo e($post->id); ?>" data-title="<?php echo e($post->title); ?>" data-description="<?php echo e($post->description); ?>" data-photo="<?php echo e($post->photo); ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                        <a class="dropdown-item delete-post" href="javascript:void(0);" data-post-id="<?php echo e($post->id); ?>"><i class="bx bx-trash me-1"></i> Delete</a>
                    </div>
                </div>
            </td>
        </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="<?php echo e(route('addpost')); ?>" id="add" enctype="multipart/form-data">
          <div class="mb-3">
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Book\resources\views/admin/post.blade.php ENDPATH**/ ?>