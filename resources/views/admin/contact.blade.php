      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
           ...
           <tr>
            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $con->name }}</strong></td>
            <td>{{ $con->email }}</td>
            <td>{{ $con->subject }}</td>
            <td style=" max-width: 5px;"><span class="badge bg-label-primary me-1" >  <a class="dropdown-item show-con" href="javascript:void(0);" data-con-message="{{ $con->message }}"> Show </a> </span></td>
            <td>
                
                        <a class="dropdown-item delete-con" href="javascript:void(0);" data-con-id="{{ $con->id }}"><i class="bx bx-trash me-1"></i> Delete</a>
                </div>
            </td>
        </tr>
        @endforeach
