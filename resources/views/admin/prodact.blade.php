            ...
            @if(session('success'))
              ...
              <span class="text-end"><a href="#" id="addPostLink">Add prodact</a></span>
                  ...
                  <table class="table">
                    ...
                    @foreach ($prodact as $post)
           <tr>
            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $post->name }}</strong></td>
            ...
            <td>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item edit-product" href="javascript:void(0);" data-post-id="{{ $post->id }}" data-name="{{ $post->name }}" data-description="{{ $post->description }}" data-photo="{{ $post->photo }}" data-price="{{ $post->price }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                        <a class="dropdown-item delete-product" href="javascript:void(0);" data-post-id="{{ $post->id }}"><i class="bx bx-trash me-1"></i> Delete</a>
                    </div>
                </div>
            </td>
        </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="{{ route('addproduct') }}" id="add" enctype="multipart/form-data">
          <div class="mb-3">
